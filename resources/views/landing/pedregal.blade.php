...
<section class="relative w-full h-64 md:h-[32rem] bg-cover bg-center pt-20"
    style="background-image: url('{{ asset('images/clinicas/PBanner.jpg') }}');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full">
        ...
        <h2 class="text-center text-white font-semibold mb-4 lg:text-[34px] text-[24px]">
           Nulla dictum mauris et neque bibendum
        </h2>
    </div>
</section>
...
<section class="lg:p-20 py-20 px-8">
    <div class="max-w-6xl mx-auto">
        <h2 class="text-center font-semibold mb-4 lg:text-[34px] text-[24px]">
           Ut vel ultrices nisl. Curabitur a viverra turpis. Morbi sodales lobortis auctor. Aenean aliquam augue quis mi facilisis.
        </h2>
        <p class="text-center lg:text-[18px] text-[16px] mb-12">
            Nuestra <strong>clínica semper condimentum</strong> está diseñada para atender a pacientes que buscan diagnóstico médico confiable y tratamientos. 
            En esta sede priorizamos la valoración médica, 
            el seguimiento clínico y la atención cercana en un entorno cómodo y profesional.
        </p>
...
<div class="pt-15">
    ...
    <section class="py-16 px-6 bg-white">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="w-full h-96 rounded-2xl overflow-hidden shadow-lg">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d1174.9288039345888!2d-99.66710415812065!3d19.287503403461805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1ses-419!2smx!4v1780707326116!5m2!1ses-419!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-6 bg-gray-50">
        <div class="max-w-6xl mx-auto text-center">
            ...
            <!-- Carrusel Swiper -->
            <div class="swiper instalacionesPED">
                <div class="swiper-wrapper">
                    

                    <!-- Slide 6 -->
                    <div class="swiper-slide">
                        <img src="{{ asset('images/clinicas/P4.jpg') }}" alt="Instalaciones Pedregal 1"
                            class="rounded-xl w-full h-[350px] md:h-[650px] object-cover" loading="lazy" />
                    </div>

                    <!-- Slide 3 -->
                    <div class="swiper-slide">
                        <img src="{{ asset('images/clinicas/P1.jpg') }}" alt="Instalaciones Pedregal 3"
                            class="rounded-xl w-full h-[350px] md:h-[650px] object-cover" loading="lazy" />
                    </div>

                    <!-- Slide 4 -->
                    <div class="swiper-slide">
                        <img src="{{ asset('images/clinicas/P2.jpg') }}" alt="Instalaciones Pedregal 4"
                            class="rounded-xl w-full h-[350px] md:h-[650px] object-cover" loading="lazy" />
                    </div>

                    <!-- Slide 5 -->
                    <div class="swiper-slide">
                        <img src="{{ asset('images/clinicas/P3.jpg') }}" alt="Instalaciones Pedregal 5"
                            class="rounded-xl w-full h-[350px] md:h-[650px] object-cover" loading="lazy" />
                    </div>
            ...
            <div class="w-full rounded-2xl shadow-lg overflow-hidden">
                <div class="relative pb-[56.25%] h-0"> <!-- Mantiene relación 16:9 -->
                    <video class="absolute top-0 left-0 w-full h-full object-contain md:object-cover" controls
                        ...
                        <source src="{{ asset('images/recorrido/Recorrido1.mp4') }}" type="video/webm">
...
<section class="lg:p-20 py-20 px-8">
    <div class="container mx-auto">
        ...
        <p class="text-verdeOscuro/80 mb-4 text-center">
            En nuestra clínica, cada tratamiento está respaldado por un equipo médico especializado y opciones diseñadas según tu diagnóstico y tipo de alopecia.
        </p>
