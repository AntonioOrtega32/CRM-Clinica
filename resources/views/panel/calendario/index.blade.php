        ...
        <div @class(['w-1/4', 'hidden', 'md:flex', 'flex-col', 'space-y-6'])>
            ...
            <div @class([
                ...
                <form id="copyAgendaForm" method="POST" action="{{ route('panel.calendar.copyAgenda') }}">
                    ...
                    <input type="text" name="clinic" value="Santafe">
        ...
        $(document).ready(function() {
            ...
            window.calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventContent(arg) {
                    ...
                    const tipo = extendedProps?.tipo_final ?
                        extendedProps.tipo_final.toUpperCase() :
                        '';

                    return {
                        html: `
            <div class="fc-custom-event">
                <div class="fc-custom-title">
                    ${title}
                        ...
                        const events = response.events
                            .map(e => {
                                ...
                                return {
                                    ...
                                    classNames: [
                                        tipo_final === 'procedimiento' ?
                                        'evento-procedimiento' : null,
                                        e.extendedProps?.protocolo_alejandro ?
                                        'protocolo-alejandro' : null
                                    ].filter(Boolean),
