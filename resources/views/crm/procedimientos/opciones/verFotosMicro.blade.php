...
@section('content')
    <section class="py-10 px-6 bg-white">
        <div class="p-6 space-y-6">
            <div>
                <h1 class="text-3xl font-[Poppins] text-[#1C6C73] mb-2">Fotos y notas de Micropigmentación</h1>
                    ...
                    @foreach ($folderNames as $key => $label)
                        ...
                        <div class="swiper-slide text-center {{ $bloquear ? 'opacity-50 pointer-events-none' : '' }}"
                            ...
                            <div class="flex flex-col items-center">
                                <a href="{{ route('panel.procedimientos.fotos.micro', ['num_med_record' => $num_med_record, 'step' => $key]) }}"
            ...
            <form id="uploadForm" disabled
                action="{{ route('panel.procedimientos.subirFotoMicro', ['num_med_record' => $num_med_record, 'step' => $step]) }}"
                ...
                @else
                    <button type="button" id="btnPickFilesMicro" disabled 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach ($imagenes as $img)
                            <div class="border p-3 rounded-lg shadow hover:shadow-lg transition bg-white">
                                ...
                                <form action="{{ route('panel.procedimientos.eliminarFotoMicro') }}" method="POST"
        ...
        <div id="modalNotas"
            ...
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-3xl p-6 relative animate-fadeIn">
                ...
                <form id="formNota" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <input type="hidden" name="procedure_type" value="micro">
        ...
        <script>
            ...
            const dropArea = form;
            const btnPick = document.getElementById('btnPickFilesMicro');
            ...
            async function uploadFiles(files) {
                ...
                // tu backend hace redirect (HTML), solo validamos status
                if (!res.ok) {
